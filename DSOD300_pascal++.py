...
train_data = "/home/szq/Datasets/VOCdevkit/VOC0712Plus/lmdb/VOC0712Plus_trainvalplus_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "/home/szq/Datasets/VOCdevkit/VOC0712Plus/lmdb/VOC0712Plus_test_lmdb"
...
model_name = "DSOD300_VOC0712Plus_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/DSOD300/VOC0712Plus/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/DSOD300/VOC0712Plus/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/DSOD300/VOC0712Plus/{}".format(job_name)
